        ...
        <ul >
          <li className="text-left mb-10">
            <div className="flex flex-row items-start mb-5">
              <div className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-green-600 text-white border-4 border-white text-xl font-semibold">
              ...
              <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                <h4 className="text-md leading-6 font-medium text-gray-900">How does the Rank Predictor tool work?</h4>
              </div>
            </div>
            <div className="flex flex-row items-start">
              <div className="bg-green-100 p-5 px-10 w-full flex items-center">
                <p className="text-gray-700 text-sm">Our Rank Predictor uses advanced algorithms to analyze your JEE Mains/Advanced rank and provide an accurate prediction of which engineering colleges you’re likely to get into. Just enter your rank, and let the tool do the rest!
                </p>
              </div>
              <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-green-600 text-white border-4 border-white text-xl font-semibold">
          ...
          <li className="text-left mb-10">
            <div className="flex flex-row items-start mb-5">
              ...
              <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                <h4 className="text-md leading-6 font-medium text-gray-900">Can I trust the college details provided on GrowUp?</h4>
              </div>
            </div>
            <div className="flex flex-row items-start">
              <div className="bg-green-100 p-5 px-10 w-full flex items-center">
                <p className="text-gray-700 text-sm">Absolutely! Our platform is updated regularly with accurate, real-time data on NITs, IITs, and other top engineering colleges. We gather verified information to help you make informed decisions.
                </p>
              </div>
              <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-green-60 text-white border-4 border-white text-xl font-semibold">
                <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
                  <g>
                    <g>
                      <g>
          ...
          <li className="text-left mb-10">
            <div className="flex flex-row items-start mb-5">
              <div className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-green-60 text-white border-4 border-white text-xl font-semibold">
                <svg width="30px" fill="white" height="30px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <g data-name="Layer 2">
                    <g data-name="menu-arrow">
                      <rect width={24} height={24} transform="rotate(180 12 12)" opacity={0} />
              ...
              <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                <h4 className="text-md leading-6 font-medium text-gray-900">How accurate is the Rank Predictor?</h4>
              </div>
            </div>
            <div className="flex flex-row items-start">
              <div className="bg-green-100 p-5 px-10 w-full flex items-center">
                <p className="text-gray-700 text-sm">While our predictor is designed to be highly accurate, results may vary depending on changes in admission trends and seat availability. It provides a reliable estimate to guide your decision-making process.
                </p>
              </div>
              <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-green-600 text-white border-4 border-white text-xl font-semibold">
                <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
